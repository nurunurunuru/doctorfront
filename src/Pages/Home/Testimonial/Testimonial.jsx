...
const Testimonial = () => {
    ...
    return (
        <div className='mt-16 container mx-auto px-5 md:px-0'>
            <div className='pl-6 mt-6 flex justify-between items-center mb-10'>
                <div>
            ...
            <div className='mt-24 grid md:grid-cols-3 gap-5 px-5'>
